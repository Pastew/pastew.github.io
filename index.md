...
<br/>
# My personal game related projects
### Level based puzzle game for mobile devices
...
I was interested in soft body physics during my university studies, so I wanted to create a game using it. I found [great repo](https://github.com/kwanchangnim/Jello-Physics) I utilized in my game.
...
![img]({{ '/assets/images/isexam.png' | relative_url}} ){: .center-image .height50}
...
![img]({{ 'https://github.com/Pastew/ingameads-server/raw/master/architecture.PNG?raw=true'  }}){: .center-image .height40}
...
![img]({{ 'https://raw.githubusercontent.com/Pastew/browsergotchi/master/screenshots/sad_example_youtube.png'  }}){: .center-image .height30}